...
Revision ID: 94b976bf6772
Revises: 
Create Date: 2022-12-22 18:57:31.164267
...
def upgrade():
    ...
    sa.Column('club_image', sa.String(), nullable=True),
    sa.Column('club_banner', sa.String(), nullable=True),
